...
PKGDEPS = libalut-dev libmagick++-dev freeglut3-dev libglew-dev libassimp-dev libsdl2-dev libsdl2-image-dev libsdl2-ttf-dev libsdl2-mixer-dev
INCLUDE = assimp freealut glew Magick++ sdl2 SDL2_image SDL2_ttf SDL2_mixer
