...
#define _c(x,ind) (*s)[x].p(ind, __FILE__, __LINE__)
#define _cs(x,ind) (*s)[x].p(ind, __FILE__, __LINE__).s(__FILE__, __LINE__)
#define _ci(x,ind) (*s)[x].p(ind, __FILE__, __LINE__).i(__FILE__, __LINE__)
#define _cd(x,ind) (*s)[x].p(ind, __FILE__, __LINE__).d(__FILE__, __LINE__)
#define _cp(x,ind) (*s)[x].p(ind, __FILE__, __LINE__).p(__FILE__, __LINE__)
