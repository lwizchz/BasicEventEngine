...
class BEE::Path: public Resource { // The path resource class is used to repeatedly move instances in complex, predefined patterns
		...
		std::vector<bee_path_coord> coordinate_list; // The list of points which the instance will follow, see bee/game.hpp for the typedef of bee_path_coord
	...
	public:
		...
		std::vector<bee_path_coord> get_coordinate_list() const;
