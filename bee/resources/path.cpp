...
/*
* BEE::Path::Path() - Construct the path and set its engine pointer
...
/*
* BEE::Path::Path() - Construct the path, reset all variables, add it to the path resource list, and set the new name and path
...
/*
* BEE::Path::~Path() - Remove the path from the resource list
*/
BEE::Path::~Path() {
	BEE::resource_list->paths.remove_resource(id);
}
/*
* BEE::Path::add_to_resources() - Add the path to the appropriate resource list
*/
...
/*
* BEE::Path::reset() - Reset all resource variables for reinitialization
*/
int BEE::Path::reset() {
...
/*
* BEE::Path::print() - Print all relevant information about the resource
*/
int BEE::Path::print() const {
...
/*
* BEE::Path::get_*() - Return the requested resource information
*/
int BEE::Path::get_id() const {
	return id;
}
std::string BEE::Path::get_name() const {
	return name;
}
std::string BEE::Path::get_path() const {
	return path;
}
std::vector<bee_path_coord> BEE::Path::get_coordinate_list() const {
	return coordinate_list;
}
std::string BEE::Path::get_coordinate_string() const {
...
bool BEE::Path::get_is_curved() const {
	return is_curved;
}
bool BEE::Path::get_is_closed() const {
	return is_closed;
}

/*
* BEE::Path::set_name() - Set the resource name
...
/*
* BEE::Path::set_path() - Set the resource path
...
/*
* BEE::Path::set_is_curved() - Set whether the path should curve
* @new_is_curved: the new curvature to use
*/
int BEE::Path::set_is_curved(bool new_is_curved) {
	is_curved = new_is_curved; // Set the curvature
	return 0; // Return 0 on success
}
/*
* BEE::Path::set_is_closed() - Set whether the path should loop after the end
...
/*
* BEE::Path::add_coordinate() - Add a coordinate to the end of the coordinate list
...
/*
* BEE::Path::add_coordinate() - Add the given coordinate and speed to the coordinate list
...
*/
int BEE::Path::add_coordinate(double x, double y, double z, double speed) {
	return add_coordinate(bee_path_coord(x, y, z, speed)); // Construct the path coordinate and return the attempt to add it
}
/*
* BEE::Path::add_coordinate() - Add the given coordinate and speed to the coordinate list
...
* @speed: the speed at the desired point
*/
int BEE::Path::add_coordinate(double x, double y, double speed) {
	return add_coordinate(x, y, 0.0, speed);
}
/*
* BEE::Path::remove_last_coordinate() - Remove the last coordinate from the list
*/
...
/*
* BEE::Path::remove_coordinate() - Remove the coordinate at the given index
...
/*
* BEE::Path::draw() - Draw the path for debugging purposes
...
int BEE::Path::draw(double xstart, double ystart, double zstart) {
	...
	for (auto it = coordinate_list.begin(); it != --coordinate_list.end(); ) { // Iterate over the coordinates
		...
		game->draw_line(v1+vs, v2+vs, c_line); // Draw the line with the start point added
	}
...
* @ystart: the y-coordinate to offset the path by
*/
int BEE::Path::draw(double xstart, double ystart) {
