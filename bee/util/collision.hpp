...
bool check_collision_circle(float x1, float y1, float r1, float x2, float y2, float r2) {
...
bool check_collision_line(Line line1, Line line2) {
        float m1 = (line1.y2-line1.y1) / (line1.x2-line1.x1); // Slope
        float m2 = (line2.y2-line2.y1) / (line2.x2-line2.x1);
        float b1 = line1.y1 - m1*line1.x1; // y-intercept
        ...
        float cx = (b2-b1) / (m2-m1); // Possible collision
